...
public class Context
{
  ...
  public static final boolean generatingDebugChanged = false;
  public static final String nodeSet = "AnimatorInflater";
  
  public Context() {}
  
  public static void build(ValueAnimator paramValueAnimator, TypedArray paramTypedArray, int paramInt, float paramFloat, XmlPullParser paramXmlPullParser)
  {
    paramValueAnimator = (ObjectAnimator)paramValueAnimator;
    String str1 = TypedArrayUtils.getValue(paramTypedArray, paramXmlPullParser, "pathData", 1);
    if (str1 != null)
    {
      String str2 = TypedArrayUtils.getValue(paramTypedArray, paramXmlPullParser, "propertyXName", 2);
      paramXmlPullParser = TypedArrayUtils.getValue(paramTypedArray, paramXmlPullParser, "propertyYName", 3);
      ...
      parse(PathParser.toString(str1), paramValueAnimator, paramFloat * 0.5F, str2, paramXmlPullParser);
      return;
    }
    paramValueAnimator.setPropertyName(TypedArrayUtils.getValue(paramTypedArray, paramXmlPullParser, "propertyName", 0));
  }
  
  public static int create(Resources paramResources, Resources.Theme paramTheme, AttributeSet paramAttributeSet, XmlPullParser paramXmlPullParser)
  {
    paramResources = TypedArrayUtils.obtainAttributes(paramResources, paramTheme, paramAttributeSet, R.raw.y);
    int k = 0;
    paramTheme = TypedArrayUtils.getString(paramResources, paramXmlPullParser, "value", 0);
    int i;
    if (paramTheme != null) {
      i = 1;
    } else {
  ...
  public static Keyframe create(android.content.Context paramContext, Resources paramResources, Resources.Theme paramTheme, AttributeSet paramAttributeSet, int paramInt, XmlPullParser paramXmlPullParser)
    throws XmlPullParserException, IOException
  {
    paramTheme = TypedArrayUtils.obtainAttributes(paramResources, paramTheme, paramAttributeSet, R.raw.y);
    float f = TypedArrayUtils.getNamedFloat(paramTheme, paramXmlPullParser, "fraction", 3, -1.0F);
    paramResources = TypedArrayUtils.getString(paramTheme, paramXmlPullParser, "value", 0);
    int j;
    ...
    paramInt = TypedArrayUtils.getInt(paramTheme, paramXmlPullParser, "interpolator", 1, 0);
    if (paramInt > 0) {
  ...
  public static PropertyValuesHolder create(android.content.Context paramContext, Resources paramResources, Resources.Theme paramTheme, XmlPullParser paramXmlPullParser, String paramString, int paramInt)
    throws XmlPullParserException, IOException
  {
    ...
    for (;;)
    {
      ...
      if (paramXmlPullParser.getName().equals("keyframe"))
      {
        paramInt = j;
        if (j == 4) {
          paramInt = create(paramResources, paramTheme, Xml.asAttributeSet(paramXmlPullParser), paramXmlPullParser);
        }
        Keyframe localKeyframe = create(paramContext, paramResources, paramTheme, Xml.asAttributeSet(paramXmlPullParser), paramInt, paramXmlPullParser);
    ...
    if (localObject1 != null)
    {
      ...
      if (k > 0)
      {
        ...
        paramContext.setEvaluator(Type.LONG_TYPE);
        return paramContext;
      }
    }
    return null;
  ...
  public static Animator createAnimatorFromXml(android.content.Context paramContext, Resources paramResources, Resources.Theme paramTheme, XmlPullParser paramXmlPullParser, float paramFloat)
    throws XmlPullParserException, IOException
  {
  ...
  public static Animator createAnimatorFromXml(android.content.Context paramContext, Resources paramResources, Resources.Theme paramTheme, XmlPullParser paramXmlPullParser, AttributeSet paramAttributeSet, AnimatorSet paramAnimatorSet, int paramInt, float paramFloat)
    throws XmlPullParserException, IOException
  {
    ...
    for (;;)
    {
      ...
      if (m == 2)
      {
        ...
        if (((String)localObject1).equals("set"))
        {
          ...
          localObject3 = TypedArrayUtils.obtainAttributes(paramResources, paramTheme, paramAttributeSet, R.raw.data);
    ...
    paramContext = f.sufficientlysecure.rootcommands.util.StringBuilder.append("Unknown animator name: ");
  ...
  public static boolean generate(int paramInt)
  {
    return (paramInt >= 28) && (paramInt <= 31);
  }
  
  public static PropertyValuesHolder get(TypedArray paramTypedArray, int paramInt1, int paramInt2, int paramInt3, String paramString)
  {
    ...
    int i = paramInt1;
    if (paramInt1 == 4) {
      if (((j != 0) && (generate(m))) || ((k != 0) && (generate(n)))) {
        i = 3;
      } else {
        i = 0;
      }
  ...
  public static int getType(TypedArray paramTypedArray, int paramInt1, int paramInt2)
  {
    ...
    if (((paramInt1 != 0) && (generate(i))) || ((paramInt2 != 0) && (generate(j)))) {
      return 3;
    }
    return 0;
  }
  
  public static void getValue(Keyframe[] paramArrayOfKeyframe, float paramFloat, int paramInt1, int paramInt2)
  {
  ...
  public static PropertyValuesHolder[] inflate(android.content.Context paramContext, Resources paramResources, Resources.Theme paramTheme, XmlPullParser paramXmlPullParser, AttributeSet paramAttributeSet)
    throws XmlPullParserException, IOException
  {
    Object localObject1 = null;
    int j;
    ...
    for (;;)
    {
      ...
      else
      {
        ...
        {
          TypedArray localTypedArray = TypedArrayUtils.obtainAttributes(paramResources, paramTheme, paramAttributeSet, R.raw.z);
          String str = TypedArrayUtils.getValue(localTypedArray, paramXmlPullParser, "propertyName", 3);
          ...
          if (localObject2 == null) {
            localObject3 = get(localTypedArray, i, 0, 1, str);
          }
          localObject2 = localObject1;
  ...
  public static void load(ValueAnimator paramValueAnimator, TypedArray paramTypedArray1, TypedArray paramTypedArray2, float paramFloat, XmlPullParser paramXmlPullParser)
  {
    ...
    int i = k;
    int j = i;
    if (TypedArrayUtils.get(paramXmlPullParser, "valueFrom"))
    {
      j = i;
      if (TypedArrayUtils.get(paramXmlPullParser, "valueTo"))
      {
        if (k == 4) {
          i = getType(paramTypedArray1, 5, 6);
        }
        PropertyValuesHolder localPropertyValuesHolder = get(paramTypedArray1, i, 5, 6, "");
        j = i;
  ...
  public static ValueAnimator loadAnimator(android.content.Context paramContext, Resources paramResources, Resources.Theme paramTheme, AttributeSet paramAttributeSet, ValueAnimator paramValueAnimator, float paramFloat, XmlPullParser paramXmlPullParser)
    throws Resources.NotFoundException
  {
    TypedArray localTypedArray = TypedArrayUtils.obtainAttributes(paramResources, paramTheme, paramAttributeSet, R.raw.Animator);
    paramTheme = TypedArrayUtils.obtainAttributes(paramResources, paramTheme, paramAttributeSet, R.raw.type);
    ...
    int i = TypedArrayUtils.getInt(localTypedArray, paramXmlPullParser, "interpolator", 0, 0);
    if (i > 0) {
  ...
  public static ObjectAnimator loadObjectAnimator(android.content.Context paramContext, Resources paramResources, Resources.Theme paramTheme, AttributeSet paramAttributeSet, float paramFloat, XmlPullParser paramXmlPullParser)
    throws Resources.NotFoundException
  {
  ...
  public static void parse(Path paramPath, ObjectAnimator paramObjectAnimator, float paramFloat, String paramString1, String paramString2)
  {
  ...
  public static Keyframe toString(Keyframe paramKeyframe, float paramFloat)
  {
  ...
  public static void toString(Object[] paramArrayOfObject, String paramString)
  {
    if (paramArrayOfObject != null)
    {
      ...
      while (i < j)
      {
        ...
        StringBuilder localStringBuilder = f.sufficientlysecure.rootcommands.util.StringBuilder.append("Keyframe ", i, ": fraction ");
