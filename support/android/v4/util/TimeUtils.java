...
public final class TimeUtils
{
  ...
  public static int accumField(int paramInt1, int paramInt2, boolean paramBoolean, int paramInt3)
  {
  ...
  {
    Object localObject = sFormatSync;
    try
    {
  ...
  public static int formatDurationLocked(long paramLong, int paramInt)
  {
    long l = paramLong;
    ...
    if (paramInt != 0)
    {
      ...
      j = accumField(n, 1, bool, 2) + j;
      if (j > 0) {
        bool = true;
      } else {
        bool = false;
      }
      j = accumField(i1, 1, bool, 2) + j;
      if (j > 0) {
        bool = true;
      } else {
        bool = false;
      }
      i2 = accumField(k, 1, bool, 2) + j;
      if (i2 > 0) {
        j = 3;
      } else {
        j = 0;
      }
      i2 = accumField(i4, 2, true, j) + 1 + i2;
      j = 0;
      for (;;)
      {
        i3 = j;
  ...
  public static int printField(char[] paramArrayOfChar, int paramInt1, char paramChar, int paramInt2, boolean paramBoolean, int paramInt3)
  {
    if ((paramBoolean) || (paramInt1 > 0))
    {
      int j;
