...
import support.android.v4.view.ViewPropertyAnimatorUpdateListener;
  ...
  implements ActionBarOverlayLayout.ActionBarVisibilityCallback
{
  ...
  private DecorToolbar getDecorToolbar(View paramView)
  {
    ...
    StringBuilder localStringBuilder = f.sufficientlysecure.rootcommands.util.StringBuilder.append("Can't make a decor toolbar out of ");
    if (paramView != null) {
