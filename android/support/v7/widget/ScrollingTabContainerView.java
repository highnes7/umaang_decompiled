  ...
  implements AdapterView.OnItemSelectedListener
{
  ...
  public ScrollingTabContainerView(Context paramContext)
  {
    ...
    paramContext = new ActionBarPolicy(paramContext);
  ...
  {
    AppCompatSpinner localAppCompatSpinner = new AppCompatSpinner(getContext(), null, R.attr.actionDropDownStyle, -1);
  ...
  public void onConfigurationChanged(Configuration paramConfiguration)
  {
    ...
    paramConfiguration = new ActionBarPolicy(getContext());
  ...
  {
    public final int[] BG_ATTRS = { 16842964 };
    ...
    public void update()
    {
      ...
      else
      {
        ...
        if (localObject2 != null) {
          ((View)localObject2).setContentDescription(localTab.getContentDescription());
        }
        if (!bool) {
