  ...
  implements OpReorderer.Callback
{
  ...
  public r.a<UpdateOp> mUpdateOpPool = new Pools.SimplePool(30);
    ...
    if ((i != 1) && (i != 8))
    {
      ...
      if (k != 2)
      {
        if (k == 4) {
          ...
          throw new IllegalArgumentException(f.sufficientlysecure.rootcommands.util.StringBuilder.toString("op should be remove or update.", paramUpdateOp));
        }
      }
      else {
        m = 0;
      ...
      while (n < itemCount)
      {
        ...
        {
          localObject = obtainUpdateOp(cmd, j, k, payload);
    ...
    if (i != 1)
    {
      if (i != 2)
      {
        if (i != 4)
        {
          ...
          throw new IllegalArgumentException(f.sufficientlysecure.rootcommands.util.StringBuilder.toString("Unknown update op type for ", paramUpdateOp));
        }
  ...
  public void recycleUpdateOpsAndClearList(List paramList)
  {
  ...
  public static class UpdateOp
  {
    ...
    public String toString()
    {
      ...
      return f.sufficientlysecure.rootcommands.util.StringBuilder.append(localStringBuilder, payload, "]");
    }
  }
}
