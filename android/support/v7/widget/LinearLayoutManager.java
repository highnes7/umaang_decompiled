  ...
  implements ItemTouchHelper.ViewDropHandler, RecyclerView.SmoothScroller.ScrollVectorProvider
{
    ...
    if ((paramState.willRunPredictiveAnimations()) && (getChildCount() != 0) && (!paramState.isPreLayout()))
    {
      ...
      while (i < n)
      {
        ...
        if (!localViewHolder.isRemoved())
        {
          ...
          if (m == -1) {
            j = mOrientationHelper.getDecoratedMeasurement(itemView) + j;
          } else {
            k = mOrientationHelper.getDecoratedMeasurement(itemView) + k;
          }
        }
        i += 1;
      }
  ...
  private void logChildren()
  {
    ...
    while (i < getChildCount())
    {
      ...
      StringBuilder localStringBuilder = f.sufficientlysecure.rootcommands.util.StringBuilder.append("item ");
  ...
  private void updateLayoutState(int paramInt1, int paramInt2, boolean paramBoolean, RecyclerView.State paramState)
  {
    ...
    int i = -1;
    LayoutState localLayoutState1;
    LayoutState localLayoutState2;
    if (paramInt1 == 1)
    {
      paramInt1 = mExtra;
      mExtra = (mOrientationHelper.getEndPadding() + paramInt1);
      paramState = getChildClosestToEnd();
      localLayoutState1 = mLayoutState;
      if (!mShouldReverseLayout) {
        i = 1;
      }
      mItemDirection = i;
      ...
      localLayoutState2 = mLayoutState;
      mCurrentPosition = (paramInt1 + mItemDirection);
      mOffset = mOrientationHelper.getDecoratedEnd(paramState);
    ...
    else
    {
      ...
      localLayoutState1 = mLayoutState;
      paramInt1 = mExtra;
      mExtra = (mOrientationHelper.getStartAfterPadding() + paramInt1);
      localLayoutState1 = mLayoutState;
      if (mShouldReverseLayout) {
        i = 1;
      }
  ...
  public void collectInitialPrefetchPositions(int paramInt, RecyclerView.LayoutManager.LayoutPrefetchRegistry paramLayoutPrefetchRegistry)
  {
    ...
    int k = i;
    int i = 0;
    while ((i < mInitialPrefetchItemCount) && (k >= 0) && (k < paramInt))
    {
  ...
  public int fill(RecyclerView.Recycler paramRecycler, LayoutState paramLayoutState, RecyclerView.State paramState, boolean paramBoolean)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        j = mOffset;
        mOffset = (mConsumed * mLayoutDirection + j);
  ...
  public void layoutChunk(RecyclerView.Recycler paramRecycler, RecyclerView.State paramState, LayoutState paramLayoutState, LayoutChunkResult paramLayoutChunkResult)
  {
    ...
    layoutDecoratedWithMargins(paramRecycler, m, j, i, k);
  ...
  public void onLayoutChildren(RecyclerView.Recycler paramRecycler, RecyclerView.State paramState)
  {
    ...
    int m = mOrientationHelper.getStartAfterPadding() + j;
    int n = mOrientationHelper.getEndPadding() + i;
    i = m;
    j = n;
    int i1;
    if (paramState.isPreLayout())
  ...
  public void setOrientation(int paramInt)
  {
    if ((paramInt != 0) && (paramInt != 1)) {
      throw new IllegalArgumentException(f.sufficientlysecure.rootcommands.util.StringBuilder.toString("invalid orientation:", paramInt));
    }
  ...
  {
    Object localObject = f.sufficientlysecure.rootcommands.util.StringBuilder.append("validating child count ");
    ...
    if (mShouldReverseLayout)
    {
      ...
      for (;;)
      {
        ...
        {
          logChildren();
          localObject = f.sufficientlysecure.rootcommands.util.StringBuilder.append("detected invalid position. loc invalid? ");
          if (n < k) {
            bool1 = true;
          }
  ...
  public static class AnchorInfo
  {
    ...
    public void assignFromViewAndKeepVisibleRect(View paramView, int paramInt)
    {
      ...
      if (mLayoutFromEnd)
      {
        ...
        if (paramInt > 0)
        {
          ...
          i = j - i - (Math.min(mOrientationHelper.getDecoratedStart(paramView) - k, 0) + k);
          if (i < 0)
          {
            j = mCoordinate;
    ...
    {
      StringBuilder localStringBuilder = f.sufficientlysecure.rootcommands.util.StringBuilder.append("AnchorInfo{mPosition=");
  ...
  public static class LayoutState
  {
    ...
    public void log()
    {
      StringBuilder localStringBuilder = f.sufficientlysecure.rootcommands.util.StringBuilder.append("avail:");
