  ...
  implements MenuBuilder.ItemInvoker, MenuView
{
  ...
  private void onMeasureExactFormat(int paramInt1, int paramInt2)
  {
    ...
    int i12 = i11 % paramInt2 / paramInt1 + paramInt2;
    ...
    while (paramInt1 < m)
    {
      ...
      if (localView.getVisibility() != 8) {
        ...
        else
        {
          ...
          paramInt3 = StringBuilder.layout(paramInt3, rightMargin, i, paramInt2);
        }
      }
      paramInt1 += 1;
      paramInt2 = paramInt3;
