  ...
  extends SimpleItemAnimator
{
  ...
  {
    return (!paramList.isEmpty()) || (canReuseUpdatedViewHolder(paramViewHolder));
  }
  
  public void cancelAll(List paramList)
  {
    int i = paramList.size() - 1;
    while (i >= 0)
    {
  ...
  public void endAnimations()
  {
    ...
    while (i >= 0)
    {
      localDefaultItemAnimator.dispatchRemoveFinished((RecyclerView.ViewHolder)mPendingRemovals.get(i));
      localObject1 = mPendingRemovals;
      ((ArrayList)localObject1).remove(i);
      i -= 1;
    }
    ...
    while (i >= 0)
    {
      ...
      itemView.setAlpha(1.0F);
      localDefaultItemAnimator.dispatchAddFinished((RecyclerView.ViewHolder)localObject1);
      localObject1 = mPendingAdditions;
      ((ArrayList)localObject1).remove(i);
      i -= 1;
    }
    ...
    while (i >= 0)
    {
      ...
      while (j >= 0)
      {
        ...
        itemView.setAlpha(1.0F);
        localDefaultItemAnimator.dispatchAddFinished((RecyclerView.ViewHolder)localObject2);
        ((ArrayList)localObject1).remove(j);
        if (((ArrayList)localObject1).isEmpty()) {
    ...
    localDefaultItemAnimator.dispatchAnimationsFinished();
  }
  ...
  public void runPendingAnimations()
  {
    ...
    if (bool4)
    {
      ...
      ViewCompat.postOnAnimationDelayed(get0itemView, (Runnable)localObject2, l2 + l1);
    }
  }
  ...
  private static class ChangeInfo
  {
    ...
    public ChangeInfo(RecyclerView.ViewHolder paramViewHolder1, RecyclerView.ViewHolder paramViewHolder2)
    {
    ...
    {
      StringBuilder localStringBuilder = f.sufficientlysecure.rootcommands.util.StringBuilder.append("ChangeInfo{oldHolder=");
      ...
      return f.sufficientlysecure.rootcommands.util.StringBuilder.append(localStringBuilder, toY, '}');
    }
  }
