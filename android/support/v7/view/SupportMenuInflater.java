...
import support.android.v4.view.h;
  ...
  extends MenuInflater
{
    ...
    throws XmlPullParserException, IOException
  {
    ...
    do
    {
      if (j == 2)
      {
        ...
        throw new RuntimeException(f.sufficientlysecure.rootcommands.util.StringBuilder.toString("Expecting menu, got ", paramMenu));
      }
  ...
  private class MenuState
  {
    ...
    private Object newInstance(String paramString, Class[] paramArrayOfClass, Object[] paramArrayOfObject)
    {
      ...
      f.sufficientlysecure.rootcommands.util.StringBuilder.get("Cannot instantiate class: ", paramString);
      return null;
    }
    ...
    private void setItem(MenuItem paramMenuItem)
    {
      ...
      h.a(paramMenuItem, itemContentDescription);
      h.setShowAsAction(paramMenuItem, itemTooltipText);
      h.a(paramMenuItem, itemAlphabeticShortcut, itemAlphabeticModifiers);
      h.setShowAsAction(paramMenuItem, itemNumericShortcut, itemNumericModifiers);
