...
public class FloatingActionButton
  ...
  implements support.android.v4.view.TintableBackgroundView, support.android.v4.widget.TintableBackgroundView, ExpandableTransformationWidget
{
  ...
  private void onApplySupportImageTint()
  {
    ...
    if (localObject == null)
    {
      DrawableCompat.canSafelyMutateDrawable(localDrawable);
      return;
    }
  ...
  public void hide(OnVisibilityChangedListener paramOnVisibilityChangedListener, boolean paramBoolean)
  {
    ...
    extends CoordinatorLayout.Behavior<T>
  {
    ...
    public static boolean isBottomSheet(View paramView)
    {
