...
import support.android.codec.IpAddress;
import support.android.codec.PixelFormat;
import support.android.codec.SocketAddress;
...
import support.android.v4.widget.ByteVector;
import support.android.v4.widget.ViewGroupUtilsHoneycomb;
  ...
  implements ViewParentCompat.ViewParentCompatImpl
{
  ...
  public static final r.a<Rect> sRectPool = new Pools.SynchronizedPool(12);
  public OnApplyWindowInsetsListener mApplyWindowInsetsListener;
  public View mBehaviorTouchView;
  public final l<View> mChildDag = new ByteVector();
  ...
  public final NestedScrollingParentHelper mNestedScrollingParentHelper = new NestedScrollingParentHelper(this);
  ...
  {
    this(paramContext, null, PixelFormat.coordinatorLayoutStyle);
  }
  
  public CoordinatorLayout(Context paramContext, AttributeSet paramAttributeSet)
  {
    this(paramContext, paramAttributeSet, PixelFormat.coordinatorLayoutStyle);
  }
  ...
  public CoordinatorLayout(Context paramContext, AttributeSet paramAttributeSet, int paramInt)
  {
    ...
    int i = 0;
    if (paramInt == 0) {
      paramAttributeSet = paramContext.obtainStyledAttributes(paramAttributeSet, IpAddress.CoordinatorLayout, 0, SocketAddress.Widget_Support_CoordinatorLayout);
    } else {
  ...
  private void getDesiredAnchoredChildRectWithoutConstraints(View paramView, int paramInt1, Rect paramRect1, Rect paramRect2, LayoutParams paramLayoutParams, int paramInt2, int paramInt3)
  {
    ...
    i = GravityCompat.getAbsoluteGravity(i, paramInt1);
  ...
  {
    return mChildDag.get(paramView);
  }
  ...
  private void layoutChild(View paramView, int paramInt)
  {
    ...
    localRect1.setEmpty();
    sRectPool.release(localRect1);
    localRect2.setEmpty();
    sRectPool.release(localRect2);
  }
  ...
  private void layoutChildWithKeyline(View paramView, int paramInt1, int paramInt2)
  {
    ...
    i = GravityCompat.getAbsoluteGravity(i, paramInt2);
    int i2 = i & 0x7;
    int i1 = i & 0x70;
    int n = getWidth();
    int m = getHeight();
  ...
  private void offsetChildByInset(View paramView, Rect paramRect, int paramInt)
  {
    ...
    if (paramView.getWidth() > 0)
    {
      ...
      if ((localBehavior != null) && (localBehavior.getInsetDodgeRect(this, paramView, localRect1)))
      {
        ...
        {
          paramView = f.sufficientlysecure.rootcommands.util.StringBuilder.append("Rect should be within the child's bounds. Rect:");
  ...
  private void prepareChildren()
  {
    ...
    while (i < k)
    {
      ...
      while (j < k)
      {
        if (j != i)
        {
          ...
          {
            if (!mChildDag.add(localView2)) {
              mChildDag.put(localView2);
            }
            mChildDag.add(localView2, localView1);
          }
        }
        j += 1;
      }
    ...
    mDependencySortedChildren.addAll(mChildDag.getSelectedItems());
    Collections.reverse(mDependencySortedChildren);
  }
  
  public static void releaseTempRect(Rect paramRect)
  {
    paramRect.setEmpty();
  ...
  private void setupForInsets()
  {
    ...
    if (ViewCompat.getFitsSystemWindows(this))
    {
      ...
      ViewCompat.setBackground(this, mApplyWindowInsetsListener);
  ...
  {
    List localList = mChildDag.read(paramView);
  ...
  {
    paramView = mChildDag.process(paramView);
  ...
  {
    paramView = mChildDag.read(paramView);
    mTempDependenciesList.clear();
    if (paramView != null) {
      mTempDependenciesList.addAll(paramView);
    }
  ...
  public LayoutParams getResolvedLayoutParams(View paramView)
  {
    ...
    if (!mBehaviorResolved)
    {
      ...
      try
      {
        ...
        localObject = (Behavior)localObject;
        localLayoutParams.setBehavior((Behavior)localObject);
      }
      catch (Exception localException)
      {
        for (;;) {}
      }
      localObject = f.sufficientlysecure.rootcommands.util.StringBuilder.append("Default behavior class ");
    ...
    while (m < i14)
    {
      ...
      if (localView.getVisibility() != 8)
      {
        ...
        if ((i >= 0) && (i10 != 0))
        {
          ...
          i = GravityCompat.getAbsoluteGravity(i, i9) & 0x7;
          if (((i == 3) && (j == 0)) || ((i == 5) && (j != 0)))
          {
        ...
        if ((k != 0) && (!ViewCompat.getFitsSystemWindows(localView)))
        {
          ...
          i3 = View.MeasureSpec.makeMeasureSpec(i11 - (i16 + i3), i10);
  ...
  public final WindowInsetsCompat setWindowInsets(WindowInsetsCompat paramWindowInsetsCompat)
  {
    ...
    if (!LatLong.equals(mLastInsets, paramWindowInsetsCompat))
    {
    ...
    extends ViewGroup.MarginLayoutParams
  {
    ...
    public LayoutParams(Context paramContext, AttributeSet paramAttributeSet)
    {
      ...
      insetEdge = localTypedArray.getInt(IpAddress.CoordinatorLayout_Layout_layout_insetEdge, 0);
      dodgeInsetEdges = localTypedArray.getInt(IpAddress.CoordinatorLayout_Layout_layout_dodgeInsetEdges, 0);
    ...
    private void resolveAnchorView(View paramView, CoordinatorLayout paramCoordinatorLayout)
    {
      ...
      Object localObject = f.sufficientlysecure.rootcommands.util.StringBuilder.append("Could not find CoordinatorLayout descendant view with id ");
