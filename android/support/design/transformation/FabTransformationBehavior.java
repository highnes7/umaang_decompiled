  ...
  extends ExpandableTransformationBehavior
{
  ...
  private void createChildrenFadeAnimation(View paramView1, View paramView2, boolean paramBoolean1, boolean paramBoolean2, FabTransformationSpec paramFabTransformationSpec, List paramList1, List paramList2)
  {
  ...
  private void createColorAnimation(View paramView1, View paramView2, boolean paramBoolean1, boolean paramBoolean2, FabTransformationSpec paramFabTransformationSpec, List paramList1, List paramList2)
  {
  ...
  private void createElevationAnimation(View paramView1, View paramView2, boolean paramBoolean1, boolean paramBoolean2, FabTransformationSpec paramFabTransformationSpec, List paramList1, List paramList2)
  {
  ...
  private void createExpansionAnimation(View paramView1, View paramView2, boolean paramBoolean1, boolean paramBoolean2, FabTransformationSpec paramFabTransformationSpec, float paramFloat1, float paramFloat2, List paramList1, List paramList2)
  {
    if (!(paramView2 instanceof CircularRevealWidget)) {
      return;
    }
    ...
    if (paramBoolean1)
    {
      ...
      paramFabTransformationSpec = CircularRevealCompat.createCircularReveal(localCircularRevealWidget, f2, f3, MathUtils.distanceToFurthestCorner(f2, f3, 0.0F, 0.0F, paramFloat1, paramFloat2));
      paramView1 = paramFabTransformationSpec;
      paramFabTransformationSpec.addListener(new AnimatorListenerAdapter()
      {
      ...
      createPreFillRadialExpansion(paramView2, localMotionTiming.getDelay(), (int)f2, (int)f3, f1, paramList1);
    }
    else
    {
      ...
      int i = (int)f2;
      int j = (int)f3;
      createPreFillRadialExpansion(paramView2, l, i, j, paramFloat1, paramList1);
      createPostFillRadialExpansion(paramView2, localMotionTiming.getDelay(), localMotionTiming.getDuration(), timings.getTotalDuration(), i, j, f1, paramList1);
    }
    localMotionTiming.apply(paramView1);
    paramList1.add(paramView1);
    paramList2.add(new CircularRevealCompat.1(localCircularRevealWidget));
  }
  
  private void createIconFadeAnimation(View paramView1, final View paramView2, boolean paramBoolean1, boolean paramBoolean2, FabTransformationSpec paramFabTransformationSpec, List paramList1, List paramList2)
  {
    if ((paramView2 instanceof CircularRevealWidget))
    {
      ...
      paramList1.add(paramView1);
      paramList2.add(new AnimatorListenerAdapter()
      {
        public void onAnimationEnd(Animator paramAnonymousAnimator)
        {
  ...
  private void createPostFillRadialExpansion(View paramView, long paramLong1, long paramLong2, long paramLong3, int paramInt1, int paramInt2, float paramFloat, List paramList)
  {
  ...
  private void createPreFillRadialExpansion(View paramView, long paramLong, int paramInt1, int paramInt2, float paramFloat, List paramList)
  {
  ...
  private void createTranslationAnimation(View paramView1, View paramView2, boolean paramBoolean1, boolean paramBoolean2, FabTransformationSpec paramFabTransformationSpec, List paramList1, List paramList2, RectF paramRectF)
  {
    ...
    if ((f1 != 0.0F) && (f2 != 0.0F))
    {
      if (((paramBoolean1) && (f2 < 0.0F)) || ((!paramBoolean1) && (f2 > 0.0F)))
      {
        ...
        paramList2 = timings.getTiming("translationYCurveUpwards");
      }
      else
      {
        paramView1 = timings.getTiming("translationXCurveDownwards");
        paramList2 = timings.getTiming("translationYCurveDownwards");
      }
    }
    else
    {
      paramView1 = timings.getTiming("translationXLinear");
      paramList2 = timings.getTiming("translationYLinear");
    }
    if (paramBoolean1)
    {
      if (!paramBoolean2)
      ...
      calculateChildVisibleBoundsAtEndOfExpansion(paramView2, paramFabTransformationSpec, paramView1, paramList2, -f1, -f2, 0.0F, 0.0F, paramRectF);
    ...
    paramList2.apply(paramFabTransformationSpec);
    paramList1.add(paramView2);
    paramList1.add(paramFabTransformationSpec);
  }
