...
public class CircularRevealHelper
{
  ...
  public void buildCircularRevealCache()
  {
    if (STRATEGY == 0)
    {
      ...
      Object localObject3 = view.getDrawingCache();
      ...
      if (localObject1 != null)
      {
        ...
        ((Paint)localObject2).setShader(new BitmapShader(localObject1, (Shader.TileMode)localObject3, (Shader.TileMode)localObject3));
      }
    ...
    if (shouldDrawCircularReveal())
    {
      ...
      if (i != 0)
      {
        if (i != 1)
        {
          ...
          {
            paramCanvas = f.sufficientlysecure.rootcommands.util.StringBuilder.append("Unsupported strategy ");
