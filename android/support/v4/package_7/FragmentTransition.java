...
public class FragmentTransition
{
  ...
  public static void addSharedElementsWithMatchingNames(ArrayList paramArrayList, ArrayMap paramArrayMap, Collection paramCollection)
  {
    int i = paramArrayMap.size() - 1;
    while (i >= 0)
    {
      View localView = (View)paramArrayMap.get(i);
  ...
  public static void addToFirstInLastOut(BackStackRecord paramBackStackRecord, BackStackRecord.Op paramOp, SparseArray paramSparseArray, boolean paramBoolean1, boolean paramBoolean2)
  {
  ...
  public static ArrayMap calculateNameOverrides(int paramInt1, ArrayList paramArrayList1, ArrayList paramArrayList2, int paramInt2, int paramInt3)
  {
  ...
  public static void callSharedElementStartEnd(Fragment paramFragment1, Fragment paramFragment2, boolean paramBoolean1, ArrayMap paramArrayMap, boolean paramBoolean2)
  {
    if (paramBoolean1) {
    ...
    if (paramFragment1 != null)
    {
      ...
      while (j < i)
      {
        ...
        paramFragment2.add(paramArrayMap.get(j));
        j += 1;
      }
      if (paramBoolean2)
      {
  ...
  public static boolean canHandleAll(FragmentTransitionImpl paramFragmentTransitionImpl, List paramList)
  {
  ...
  public static ArrayMap captureInSharedElements(FragmentTransitionImpl paramFragmentTransitionImpl, ArrayMap paramArrayMap, Object paramObject, FragmentContainerTransition paramFragmentContainerTransition)
  {
    ...
    if ((!paramArrayMap.isEmpty()) && (paramObject != null) && (localView != null))
    {
      ...
      if (paramObject != null)
      {
        ...
        while (i >= 0)
        {
          ...
          else if (!paramFragmentContainerTransition.equals(ViewCompat.a(paramObject)))
          {
            ...
            if (paramFragmentContainerTransition != null) {
              paramArrayMap.put(paramFragmentContainerTransition, ViewCompat.a(paramObject));
            }
          }
          i -= 1;
        }
  ...
  public static ArrayMap captureOutSharedElements(FragmentTransitionImpl paramFragmentTransitionImpl, ArrayMap paramArrayMap, Object paramObject, FragmentContainerTransition paramFragmentContainerTransition)
  {
    ArrayMap localArrayMap;
      ...
      if (paramObject != null)
      {
        ...
        while (i >= 0)
        {
          ...
          else if (!paramFragmentContainerTransition.equals(ViewCompat.a(paramObject)))
          {
            ...
            paramArrayMap.put(ViewCompat.a(paramObject), paramFragmentContainerTransition);
          }
          i -= 1;
        }
      }
  ...
  public static FragmentTransitionImpl chooseImpl(Fragment paramFragment1, Fragment paramFragment2)
  {
    ArrayList localArrayList = new ArrayList();
    if (paramFragment1 != null)
    {
  ...
  public static ArrayList configureEnteringExitingViews(FragmentTransitionImpl paramFragmentTransitionImpl, Object paramObject, Fragment paramFragment, ArrayList paramArrayList, View paramView)
  {
  ...
  public static Object configureSharedElementsOrdered(FragmentTransitionImpl paramFragmentTransitionImpl, ViewGroup paramViewGroup, View paramView, ArrayMap paramArrayMap, FragmentContainerTransition paramFragmentContainerTransition, ArrayList paramArrayList1, ArrayList paramArrayList2, Object paramObject1, Object paramObject2)
  {
  ...
  public static Object configureSharedElementsReordered(FragmentTransitionImpl paramFragmentTransitionImpl, ViewGroup paramViewGroup, View paramView, ArrayMap paramArrayMap, FragmentContainerTransition paramFragmentContainerTransition, ArrayList paramArrayList1, ArrayList paramArrayList2, Object paramObject1, Object paramObject2)
  {
    Fragment localFragment1 = lastIn;
    Fragment localFragment2 = firstOut;
    if (localFragment1 != null) {
  ...
  public static void configureTransitionsOrdered(FragmentManagerImpl paramFragmentManagerImpl, int paramInt, FragmentContainerTransition paramFragmentContainerTransition, View paramView, ArrayMap paramArrayMap)
  {
  ...
  public static void configureTransitionsReordered(FragmentManagerImpl paramFragmentManagerImpl, int paramInt, FragmentContainerTransition paramFragmentContainerTransition, View paramView, ArrayMap paramArrayMap)
  {
    if (mContainer.onHasView()) {
      paramFragmentManagerImpl = (ViewGroup)mContainer.onFindViewById(paramInt);
    } else {
  ...
  public static FragmentContainerTransition ensureContainer(FragmentContainerTransition paramFragmentContainerTransition, SparseArray paramSparseArray, int paramInt)
  {
  ...
  public static String findKeyForValue(ArrayMap paramArrayMap, String paramString)
  {
    int j = paramArrayMap.size();
    int i = 0;
    while (i < j)
    {
      if (paramString.equals(paramArrayMap.get(i))) {
  ...
  public static Object getEnterTransition(FragmentTransitionImpl paramFragmentTransitionImpl, Fragment paramFragment, boolean paramBoolean)
  {
    if (paramFragment == null) {
      return null;
    }
  ...
  public static Object getExitTransition(FragmentTransitionImpl paramFragmentTransitionImpl, Fragment paramFragment, boolean paramBoolean)
  {
    if (paramFragment == null) {
      return null;
    }
  ...
  public static View getInEpicenterView(ArrayMap paramArrayMap, FragmentContainerTransition paramFragmentContainerTransition, Object paramObject, boolean paramBoolean)
  {
  ...
  public static Object getSharedElementTransition(FragmentTransitionImpl paramFragmentTransitionImpl, Fragment paramFragment1, Fragment paramFragment2, boolean paramBoolean)
  {
  ...
  public static Object mergeTransitions(FragmentTransitionImpl paramFragmentTransitionImpl, Object paramObject1, Object paramObject2, Object paramObject3, Fragment paramFragment, boolean paramBoolean)
  {
  ...
  public static void replaceHide(FragmentTransitionImpl paramFragmentTransitionImpl, Object paramObject, Fragment paramFragment, ArrayList paramArrayList)
  {
  ...
  public static FragmentTransitionImpl resolveSupportImpl()
  {
    try
    {
      Object localObject = Class.forName("b.b.v.z");
  ...
  public static void retainValues(ArrayMap paramArrayMap1, ArrayMap paramArrayMap2)
  {
  ...
  public static void scheduleTargetChange(FragmentTransitionImpl paramFragmentTransitionImpl, ViewGroup paramViewGroup, Fragment paramFragment, View paramView, ArrayList paramArrayList1, Object paramObject1, ArrayList paramArrayList2, Object paramObject2, ArrayList paramArrayList3)
  {
  ...
  public static void setOutEpicenter(FragmentTransitionImpl paramFragmentTransitionImpl, Object paramObject1, Object paramObject2, ArrayMap paramArrayMap, boolean paramBoolean, BackStackRecord paramBackStackRecord)
  {
    ArrayList localArrayList = mSharedElementSourceNames;
  ...
  public static void setViewVisibility(ArrayList paramArrayList, int paramInt)
  {
    if (paramArrayList == null) {
      return;
    }
  ...
  public static void startTransitions(FragmentManagerImpl paramFragmentManagerImpl, ArrayList paramArrayList1, ArrayList paramArrayList2, int paramInt1, int paramInt2, boolean paramBoolean)
  {
    if (mCurState < 1) {
      return;
    }
