...
public final class ShareCompat
{
  ...
  public static void configureMenuItem(Menu paramMenu, int paramInt, IntentBuilder paramIntentBuilder)
  {
    ...
    throw new IllegalArgumentException(f.sufficientlysecure.rootcommands.util.StringBuilder.toString("Could not find menu item with id ", paramInt, " in the supplied menu"));
  }
  ...
  public static void configureMenuItem(MenuItem paramMenuItem, IntentBuilder paramIntentBuilder)
  {
    ...
    StringBuilder localStringBuilder = f.sufficientlysecure.rootcommands.util.StringBuilder.append(".sharecompat_");
  ...
  public class IntentReader
  {
    ...
    public ComponentName mCallingActivity = ShareCompat.getCallingActivity(ShareCompat.this);
    public String mCallingPackage = ShareCompat.getCallingPackage(ShareCompat.this);
    ...
    public Uri getStream(int paramInt)
    {
      ...
      localObject = f.sufficientlysecure.rootcommands.util.StringBuilder.append("Stream items available: ");
