  ...
  implements TabHost.OnTabChangeListener
{
  ...
  public final ArrayList<android.support.v4.app.FragmentTabHost.TabInfo> mTabs = new ArrayList();
  ...
  private void ensureContent()
  {
    if (mRealTabContent == null)
    {
      ...
      StringBuilder localStringBuilder = f.sufficientlysecure.rootcommands.util.StringBuilder.append("No tab content FrameLayout found for id ");
    ...
    extends View.BaseSavedState
  {
    ...
    {
      StringBuilder localStringBuilder = f.sufficientlysecure.rootcommands.util.StringBuilder.append("FragmentTabHost.SavedState{");
      localStringBuilder.append(Integer.toHexString(System.identityHashCode(this)));
      localStringBuilder.append(" curTab=");
      return f.sufficientlysecure.rootcommands.util.StringBuilder.append(localStringBuilder, curTab, "}");
    }
  ...
  public final class TabInfo
  {
    ...
    public TabInfo(Class paramClass, Bundle paramBundle)
    {
      clss = paramClass;
      args = paramBundle;
    }
