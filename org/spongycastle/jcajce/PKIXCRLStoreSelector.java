  ...
  implements Selector<T>
{
  ...
  public static Collection getCRLs(PKIXCRLStoreSelector paramPKIXCRLStoreSelector, CertStore paramCertStore)
  ...
  public boolean match(CRL paramCRL)
  {
    ...
    Object localObject3 = Extension.deltaCRLIndicator;
    try
    {
      localObject3 = ((X509CRL)localObject2).getExtensionValue(((ASN1ObjectIdentifier)localObject3).getId());
      if (localObject3 != null) {
        localObject1 = ASN1Integer.getInstance(ASN1OctetString.getInstance(localObject3).getOctets());
      }
