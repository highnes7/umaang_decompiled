  ...
  implements SharedPreferences.OnSharedPreferenceChangeListener
{
  ...
  public static final String PAGE_KEY = "yaxim.Configuration";
  ...
  private void loadPrefs(SharedPreferences paramSharedPreferences)
  {
    ...
    paramSharedPreferences = jabberID;
    try
    {
      splitAndSetJabberID(XMPPHelper.verifyJabberID(paramSharedPreferences));
      jid_configured = true;
      return;
    }
    catch (YaximXMPPAdressMalformedException paramSharedPreferences)
    {
      StringBuilder.append("Exception in getPreferences(): ", paramSharedPreferences);
      return;
    }
  }
  ...
  {
    StringBuilder.get("onSharedPreferenceChanged(): ", paramString);
