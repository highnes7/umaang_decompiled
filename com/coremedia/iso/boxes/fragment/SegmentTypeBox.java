  ...
  extends Message
{
  ...
  public SegmentTypeBox(String paramString, long paramLong, List paramList)
  {
    super("styp");
  ...
  {
    StringBuilder localStringBuilder = f.sufficientlysecure.rootcommands.util.StringBuilder.append("SegmentTypeBox[", "majorBrand=");
