  ...
  implements Serializable
{
  ...
  public static final String CLASS_TAG = AppEventsLogger.class.getCanonicalName();
  ...
  public void onResume(AppEventsLogger paramAppEventsLogger, long paramLong, String paramString)
  {
    ...
    if (isAppActive)
    {
      Logger.e(LoggingBehavior.APP_EVENTS, 3, CLASS_TAG, "Resume for active app");
      return;
    }
    ...
    if (l1 < 0L)
    {
      Logger.e(LoggingBehavior.APP_EVENTS, 3, CLASS_TAG, "Clock skew detected");
      l1 = l2;
    }
    if (l1 > 60000L) {
  ...
  public void onSuspend(AppEventsLogger paramAppEventsLogger, long paramLong)
  {
    if (!isAppActive)
    {
      Logger.e(LoggingBehavior.APP_EVENTS, 3, CLASS_TAG, "Suspend for inactive app");
      return;
    }
