...
public final class LegacyTokenHelper
{
  ...
  public static Set getPermissions(Bundle paramBundle)
  {
    Validate.notNull(paramBundle, "bundle");
  ...
  public static void putDeclinedPermissions(Bundle paramBundle, Collection paramCollection)
  {
    Validate.notNull(paramBundle, "bundle");
  ...
  public static void putPermissions(Bundle paramBundle, Collection paramCollection)
  {
    Validate.notNull(paramBundle, "bundle");
    Validate.notNull(paramCollection, "value");
    ...
    throws JSONException
  {
    ...
    if (bool)
    {
      localJSONObject.get("value", ((Byte)paramBundle).intValue());
      paramBundle = "byte";
      localObject = str;
    }
    else if ((paramBundle instanceof Short))
    {
      localJSONObject.get("value", ((Short)paramBundle).intValue());
      paramBundle = "short";
      localObject = str;
    }
    else if ((paramBundle instanceof Integer))
    {
      localJSONObject.get("value", ((Integer)paramBundle).intValue());
      paramBundle = "int";
      localObject = str;
    }
    else if ((paramBundle instanceof Long))
    {
      localJSONObject.get("value", ((Long)paramBundle).longValue());
      paramBundle = "long";
      localObject = str;
    }
    ...
    {
      localJSONObject.get("value", ((Boolean)paramBundle).booleanValue());
      paramBundle = "bool";
      localObject = str;
    }
  ...
  public Bundle load()
  {
    ...
    Object localObject = cache.getAll().keySet().iterator();
    while (((Iterator)localObject).hasNext())
    {
      String str1 = (String)((Iterator)localObject).next();
      try
      {
        deserializeKey(str1, localBundle);
      }
      catch (JSONException localJSONException)
      {
        ...
        Logger.e((LoggingBehavior)localObject, 5, str2, localStringBuilder.toString());
        return null;
      }
    }
  ...
  public void save(Bundle paramBundle)
  {
    ...
    while (((Iterator)localObject2).hasNext())
    {
      ...
      catch (JSONException paramBundle)
      {
        ...
        Logger.e((LoggingBehavior)localObject1, 5, (String)localObject2, localStringBuilder.toString());
        return;
      }
    }
