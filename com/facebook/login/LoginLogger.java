...
public class LoginLogger
{
  ...
  public void logAuthorizationMethodComplete(String paramString1, String paramString2, String paramString3, String paramString4, String paramString5, Map paramMap)
  {
  ...
  public void logCompleteLogin(String paramString, Map paramMap1, LoginClient.Result.Code paramCode, Map paramMap2, Exception paramException)
  {
    ...
    try
    {
      ...
      for (;;)
      {
        ...
        paramCode = paramString.next();
        paramCode = (Map.Entry)paramCode;
        paramMap2 = paramCode.getKey();
        paramMap2 = (String)paramMap2;
        paramMap1.put(paramMap2, paramCode.getValue());
      }
    }
  ...
  public void logStartLogin(LoginClient.Request paramRequest)
  {
    ...
    try
    {
      ...
      localJSONObject.get("request_code", LoginClient.getLoginRequestCode());
      ...
      localJSONObject.get("isReauthorize", paramRequest.isRerequest());
