  ...
  implements Parcelable
{
  ...
  public AccessToken(String paramString1, String paramString2, String paramString3, Collection paramCollection1, Collection paramCollection2, AccessTokenSource paramAccessTokenSource, Date paramDate1, Date paramDate2)
  {
  ...
  public static AccessToken createFromBundle(List paramList, Bundle paramBundle, AccessTokenSource paramAccessTokenSource, Date paramDate, String paramString)
  {
      ...
      Utility.getGraphMeRequestWithCacheAsync(str1, new Utility.GraphMeRequestWithCacheCallback()
      {
        ...
        public void onSuccess(JSONObject paramAnonymousJSONObject)
        {
          try
          {
            ...
            localBundle.putString("user_id", paramAnonymousJSONObject);
            paramAnonymousJSONObject = paramAccessTokenCreationCallback;
            localBundle = val$extras;
            AccessTokenSource localAccessTokenSource = AccessTokenSource.FACEBOOK_APPLICATION_WEB;
            Date localDate = new Date();
            String str = paramString;
            paramAnonymousJSONObject.onSuccess(AccessToken.createFromBundle(null, localBundle, localAccessTokenSource, localDate, str));
            return;
          }
  ...
  public static AccessToken createFromRefresh(AccessToken paramAccessToken, Bundle paramBundle)
  {
    ...
    {
      paramBundle = f.sufficientlysecure.rootcommands.util.StringBuilder.append("Invalid token source: ");
  ...
  public static List getPermissionsFromBundle(Bundle paramBundle, String paramString)
  {
    ...
    throws JSONException
  {
    ...
    localJSONObject.get("version", 1);
    localJSONObject.put("token", token);
    localJSONObject.get("expires_at", expires.getTime());
    ...
    localJSONObject.get("last_refresh", lastRefresh.getTime());
  ...
  {
    StringBuilder localStringBuilder = f.sufficientlysecure.rootcommands.util.StringBuilder.append("{AccessToken", " token:");
