...
public final class NativeProtocol
{
  ...
  public static Map buildActionToAppInfoMap()
  {
  ...
  public static List buildFacebookAppList()
  {
    ArrayList localArrayList = new ArrayList();
  ...
  {
    StringBuilder localStringBuilder = f.sufficientlysecure.rootcommands.util.StringBuilder.append("content://");
  ...
  public static int computeLatestAvailableVersionFromVersionSpec(TreeSet paramTreeSet, int paramInt, int[] paramArrayOfInt)
  {
    ...
    {
      int n = ((Integer)paramTreeSet.next()).intValue();
      int m = Math.max(j, n);
      j = m;
      int k = i;
  ...
  public static Intent createProxyAuthIntent(Context paramContext, String paramString1, Collection paramCollection, String paramString2, boolean paramBoolean1, boolean paramBoolean2, DefaultAudience paramDefaultAudience)
  {
    Iterator localIterator = facebookAppInfoList.iterator();
    while (localIterator.hasNext())
    {
  ...
  public static TreeSet fetchAllAvailableProtocolVersionsForAppInfo(NativeAppInfo paramNativeAppInfo)
  {
    ...
    try
    {
      ...
      localObject1 = localCursor;
      paramNativeAppInfo = localPackageManager.resolveContentProvider(localStringBuilder.toString(), 0);
      localObject1 = localObject2;
      if (paramNativeAppInfo != null)
      {
        localObject1 = localCursor;
        localCursor = localContentResolver.query(localUri, new String[] { "version" }, null, null, null);
        paramNativeAppInfo = localCursor;
        ...
        if (localCursor != null) {
          for (;;)
          {
            ...
            localObject1 = paramNativeAppInfo;
            localTreeSet.add(Integer.valueOf(localCursor.getInt(localCursor.getColumnIndex("version"))));
          }
        }
      }
    ...
    catch (Throwable paramNativeAppInfo)
    {
      if (localObject1 != null) {
        ((Cursor)localObject1).close();
      }
  ...
  public static int getLatestAvailableProtocolVersionForAppInfoList(List paramList, int[] paramArrayOfInt)
  {
  ...
  private static abstract class NativeAppInfo
  {
    ...
    public static HashSet buildAppSignatureHashes()
    {
