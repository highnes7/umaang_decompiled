...
public final class ServerProtocol
{
  ...
  public static final String responseMessage = "com.facebook.internal.ServerProtocol";
  ...
  {
    return String.format("m.%s", new Object[] { FacebookSdk.facebookDomain });
  }
  
  public static final String getGraphUrlBase()
  {
    return String.format("https://graph.%s", new Object[] { FacebookSdk.facebookDomain });
  }
  
  public static final String getGraphVideoUrlBase()
  {
    return String.format("https://graph-video.%s", new Object[] { FacebookSdk.facebookDomain });
  }
  ...
  public static Bundle getQueryParamsForPlatformActivityIntentWebFallback(String paramString, int paramInt, Bundle paramBundle)
  {
    ...
    localObject1 = f.sufficientlysecure.rootcommands.util.StringBuilder.put("android_key_hash", (String)localObject1);
    ...
    catch (JSONException paramString)
    {
      ...
      localObject1 = responseMessage;
      localObject2 = new StringBuilder();
      ((StringBuilder)localObject2).append("Error creating Url -- ");
      ((StringBuilder)localObject2).append(paramString);
      Logger.e(paramBundle, 6, (String)localObject1, ((StringBuilder)localObject2).toString());
    }
    return null;
  }
}
