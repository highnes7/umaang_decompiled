...
{
  public static final Map<Class<?>, Setter> SETTERS = new HashMap();
    ...
    SETTERS.put(JSONArray.class, new Setter()
    {
        ...
        throws JSONException
      {
        ...
        while (i < localJSONArray.length())
        {
          ...
          {
            paramAnonymousBundle = f.sufficientlysecure.rootcommands.util.StringBuilder.append("Unexpected type in an array: ");
    ...
    while (localIterator.hasNext())
    {
      ...
      if ((localObject != null) && (localObject != JSONObject.NULL)) {
        ...
        else
        {
          ...
          {
            paramJSONObject = f.sufficientlysecure.rootcommands.util.StringBuilder.append("Unsupported type: ");
    ...
    while (localIterator.hasNext())
    {
      ...
      if (localObject1 != null)
      {
        ...
        else
        {
          ...
          {
            paramBundle = f.sufficientlysecure.rootcommands.util.StringBuilder.append("Unsupported type: ");
