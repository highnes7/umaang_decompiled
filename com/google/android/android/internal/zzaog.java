...
public final class zzaog
  implements zzanu<com.google.android.gms.internal.zzaoh>
{
  public final zzamu zzdod;
  public final zzaoh zzdss;
  
  public zzaog(zzamu paramZzamu)
  {
    zzdod = paramZzamu;
    zzdss = new zzaoh();
  }
  ...
  public final void toFile(String paramString, int paramInt)
  {
    ...
    {
      zzdss.zzdsu = paramInt;
      return;
    }
    zzdod.zzvy().append("Int xml configuration name not recognized", paramString);
  }
  ...
  public final void tryParse(String paramString1, String paramString2)
  {
    ...
    {
      zzdss.zzdmb = paramString2;
      return;
    }
    if ("ga_appVersion".equals(paramString1))
    {
      zzdss.zzdmc = paramString2;
      return;
    }
    if ("ga_logLevel".equals(paramString1))
    {
      zzdss.zzdst = paramString2;
      return;
    }
    zzdod.zzvy().append("String xml configuration name not recognized", paramString1);
  }
}
