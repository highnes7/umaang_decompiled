...
{
  public static final Pattern zzfzd = Pattern.compile("\\\\.");
  public static final Pattern zzfze = Pattern.compile("[\\\\\"/\b\f\n\r\t]");
  
  public static boolean toString(Object paramObject1, Object paramObject2)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        bool = toString(paramObject1.get(str), paramObject2.get(str));
        if (!bool) {
          return false;
        }
      }
    ...
    for (;;)
    {
      ...
      try
      {
        bool = toString(paramObject1.get(i), paramObject2.get(i));
        if (!bool) {
          return false;
        }
        i += 1;
  ...
  public static String zzgl(String paramString)
  {
    ...
    {
      Matcher localMatcher = zzfze.matcher(paramString);
      localObject1 = null;
