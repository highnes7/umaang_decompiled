  ...
  extends LineScatterCandleRadarRenderer
{
  ...
  public void drawFilledPath(Canvas paramCanvas, Path paramPath, Drawable paramDrawable)
  {
    ...
    paramCanvas = f.sufficientlysecure.rootcommands.util.StringBuilder.append("Fill-drawables not (yet) supported below API level 18, this code was run on API level ");
