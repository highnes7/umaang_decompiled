  ...
  extends Renderer
{
  ...
  public void applyValueTextStyle(IDataSet paramIDataSet)
  {
  ...
  public void drawValue(Canvas paramCanvas, ValueFormatter paramValueFormatter, float paramFloat1, Entry paramEntry, int paramInt1, float paramFloat2, float paramFloat3, int paramInt2)
  {
    mValuePaint.setColor(paramInt2);
    paramCanvas.drawText(paramValueFormatter.getFormattedValue(paramFloat1, paramEntry, paramInt1, mViewPortHandler), paramFloat2, paramFloat3, mValuePaint);
  }
