  ...
  extends LineScatterCandleRadarRenderer
{
  ...
  public void drawDataSet(Canvas paramCanvas, IScatterDataSet paramIScatterDataSet)
  {
    ...
    float f6 = Utils.convertDpToPixel(paramIScatterDataSet.getScatterShapeSize());
    float f3 = f6 / 2.0F;
    float f4 = Utils.convertDpToPixel(paramIScatterDataSet.getScatterShapeHoleRadius());
    float f5 = f4 * 2.0F;
    ...
    localScatterBuffer.setPhases(f1, f2);
            ...
            while (i < localScatterBuffer.size())
            {
              ...
              if (mViewPortHandler.isInBoundsLeft(buffer[i]))
              {
                ...
                if (((ViewPortHandler)localObject1).isInBoundsY(localObject2[j]))
                {
                  ...
                  localObject1 = buffer;
                  paramCanvas.drawLine(localObject1[i] - f3, localObject1[j] - f3, localObject1[i] + f3, localObject1[j] + f3, mRenderPaint);
                  localObject1 = buffer;
                  paramCanvas.drawLine(localObject1[i] + f3, localObject1[j] - f3, localObject1[i] - f3, localObject1[j] + f3, mRenderPaint);
                }
              }
          ...
          while (i < localScatterBuffer.size())
          {
            ...
            if (mViewPortHandler.isInBoundsLeft(buffer[i]))
            {
              ...
              if (((ViewPortHandler)localObject1).isInBoundsY(localObject2[j]))
              {
                mRenderPaint.setColor(paramIScatterDataSet.getColor(i / 2));
                localObject1 = buffer;
                paramCanvas.drawLine(localObject1[i] - f3, localObject1[j], localObject1[i] + f3, localObject1[j], mRenderPaint);
                localObject1 = buffer;
                paramCanvas.drawLine(localObject1[i], localObject1[j] - f3, localObject1[i], localObject1[j] + f3, mRenderPaint);
              }
            }
            i += 2;
          }
        ...
        while (i < localScatterBuffer.size())
        {
          ...
          if (mViewPortHandler.isInBoundsLeft(buffer[i]))
          {
            ...
            if (((ViewPortHandler)localObject2).isInBoundsY(arrayOfFloat[j]))
            {
              mRenderPaint.setColor(paramIScatterDataSet.getColor(i / 2));
              localObject2 = buffer;
              ((Path)localObject1).moveTo(localObject2[i], localObject2[j] - f3);
              localObject2 = buffer;
              ((Path)localObject1).lineTo(localObject2[i] + f3, localObject2[j] + f3);
              localObject2 = buffer;
              ((Path)localObject1).lineTo(localObject2[i] - f3, localObject2[j] + f3);
              double d = f5;
              if (d > 0.0D)
              {
                localObject2 = buffer;
                ((Path)localObject1).lineTo(localObject2[i], localObject2[j] - f3);
                localObject2 = buffer;
                ((Path)localObject1).moveTo(localObject2[i] - f3 + f6, localObject2[j] + f3 - f6);
                localObject2 = buffer;
                ((Path)localObject1).lineTo(localObject2[i] + f3 - f6, localObject2[j] + f3 - f6);
                localObject2 = buffer;
                ((Path)localObject1).lineTo(localObject2[i], localObject2[j] - f3 + f6);
                localObject2 = buffer;
                ((Path)localObject1).lineTo(localObject2[i] - f3 + f6, localObject2[j] + f3 - f6);
              }
              ...
              if ((d > 0.0D) && (k != 1122867))
              {
                ...
                localObject2 = buffer;
                ((Path)localObject1).moveTo(localObject2[i], localObject2[j] - f3 + f6);
                localObject2 = buffer;
                ((Path)localObject1).lineTo(localObject2[i] + f3 - f6, localObject2[j] + f3 - f6);
                localObject2 = buffer;
                ((Path)localObject1).lineTo(localObject2[i] - f3 + f6, localObject2[j] + f3 - f6);
      ...
      while (i < localScatterBuffer.size())
      {
        ...
        if (mViewPortHandler.isInBoundsLeft(buffer[i]))
        {
          ...
          if (((ViewPortHandler)localObject1).isInBoundsY(localObject2[j]))
          {
            ...
            {
              mRenderPaint.setStyle(Paint.Style.STROKE);
              mRenderPaint.setStrokeWidth(f6);
              localObject1 = buffer;
              paramCanvas.drawCircle(localObject1[i], localObject1[j], f4 + f7, mRenderPaint);
              if (k != 1122867)
              {
                mRenderPaint.setStyle(Paint.Style.FILL);
                mRenderPaint.setColor(k);
                localObject1 = buffer;
                paramCanvas.drawCircle(localObject1[i], localObject1[j], f4, mRenderPaint);
              }
            }
            else
            {
              mRenderPaint.setStyle(Paint.Style.FILL);
              localObject1 = buffer;
              paramCanvas.drawCircle(localObject1[i], localObject1[j], f3, mRenderPaint);
            }
          }
        }
        i += 2;
      ...
      if (mViewPortHandler.isInBoundsLeft(buffer[i]))
      {
        ...
        if (((ViewPortHandler)localObject1).isInBoundsY(localObject2[j]))
        {
          ...
          if (f5 > 0.0D)
          {
            ...
            mRenderPaint.setStrokeWidth(f6);
            localObject1 = buffer;
            paramCanvas.drawRect(localObject1[i] - f4 - f7, localObject1[j] - f4 - f7, localObject1[i] + f4 + f7, localObject1[j] + f4 + f7, mRenderPaint);
            if (k != 1122867)
            {
              mRenderPaint.setStyle(Paint.Style.FILL);
              mRenderPaint.setColor(k);
              localObject1 = buffer;
              paramCanvas.drawRect(localObject1[i] - f4, localObject1[j] - f4, localObject1[i] + f4, localObject1[j] + f4, mRenderPaint);
            }
          }
          else
          {
            mRenderPaint.setStyle(Paint.Style.FILL);
            localObject1 = buffer;
            paramCanvas.drawRect(localObject1[i] - f3, localObject1[j] - f3, localObject1[i] + f3, localObject1[j] + f3, mRenderPaint);
          }
        }
      }
      i += 2;
