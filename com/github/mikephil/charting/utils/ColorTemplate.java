...
public class ColorTemplate
{
  ...
  public static List createColors(Resources paramResources, int[] paramArrayOfInt)
  {
  ...
  public static List createColors(int[] paramArrayOfInt)
  {
    ArrayList localArrayList = new ArrayList();
    int j = paramArrayOfInt.length;
    int i = 0;
  ...
  public static int getColorWithAlphaComponent(int paramInt1, int paramInt2)
  {
