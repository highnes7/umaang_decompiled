  ...
  implements IBarDataSet
{
  ...
  public RealmBarDataSet(RealmResults paramRealmResults, String paramString1, String paramString2)
  {
  ...
  public RealmBarDataSet(RealmResults paramRealmResults, String paramString1, String paramString2, String paramString3)
  {
    super(paramRealmResults, paramString1, paramString2);
  ...
  public void build(RealmResults paramRealmResults)
  {
    ...
    while (paramRealmResults.hasNext())
    {
      ...
      Object localObject1 = mValuesField;
      try
      {
        float f = localDynamicRealmObject.getFloat((String)localObject1);
        localObject1 = mValues;
        localObject2 = mIndexField;
        ((List)localObject1).add(new BarEntry(f, localDynamicRealmObject.getInt((String)localObject2)));
      }
      ...
      localObject2 = localDynamicRealmObject.getList(mValuesField);
      localObject1 = new float[((RealmList)localObject2).size()];
      i = 0;
      localObject2 = ((RealmList)localObject2).iterator();
      while (((Iterator)localObject2).hasNext())
      {
        localObject1[i] = ((DynamicRealmObject)((Iterator)localObject2).next()).getFloat(mStackValueFieldName);
        i += 1;
      }
      mValues.add(new BarEntry((float[])localObject1, localDynamicRealmObject.getInt(mIndexField)));
    }
    calcStackSize();
  }
