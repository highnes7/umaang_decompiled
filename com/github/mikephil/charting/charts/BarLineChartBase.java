  ...
  implements BarLineScatterCandleBubbleDataProvider
{
  ...
  public void calcModulus()
  {
    ...
    if (localObject != null)
    {
      ...
      if (mLogEnabled)
      {
        localObject = f.sufficientlysecure.rootcommands.util.StringBuilder.append("X-Axis modulus: ");
  ...
  public void prepareValuePxMatrix()
  {
    if (mLogEnabled)
    {
      localObject1 = f.sufficientlysecure.rootcommands.util.StringBuilder.append("Preparing Value-Px Matrix, xmin: ");
